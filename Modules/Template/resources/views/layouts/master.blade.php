...
<body class="light-mood">
    <section class="main">
        ...
        <div class="" style="min-height: 100vh; padding-top: 56px; margin-bottom: 50px;">
            @yield('content')
        </div>
    ...
    <script src="{{ asset('js/jquery-3.7.1.js') }}" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=" crossorigin="anonymous"></script>
